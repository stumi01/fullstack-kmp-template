...
object Deps {
    object Gradle {
        ...
        const val compose = "org.jetbrains.compose:compose-gradle-plugin:${Versions.jbCompose}"
    }
    ...
    object Kotlinx {
        ...
        const val dataTime =
            "org.jetbrains.kotlinx:kotlinx-datetime:${Versions.dataTime}"
    }
    ...
    object AndroidX {
        ...
        const val appcompat = "androidx.activity:activity-compose:${Versions.activityCompose}"
        const val activityCompose = "androidx.appcompat:appcompat:${Versions.activityCompose}"
    ...
    object Ktor {
        ...
        const val clientJsonJvm = "io.ktor:ktor-client-json-jvm:${Versions.ktor}"
        const val clientLogging = "io.ktor:ktor-client-logging:${Versions.ktor}"
        const val clientLoggingJvm = "io.ktor:ktor-client-logging-jvm:${Versions.ktor}"
        const val clientSerialization = "io.ktor:ktor-client-serialization:${Versions.ktor}"
        const val clientSerializationJvm = "io.ktor:ktor-client-serialization-jvm:${Versions.ktor}"
